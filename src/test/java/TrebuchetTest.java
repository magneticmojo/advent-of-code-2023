...
class TrebuchetTest {
    ...
    private List<String> calibrationDocumentSmall;
    private List<String> calibrationDocumentWords;
    private List<String> calibrationDocumentSub;


    @BeforeEach
    void setUp() throws URISyntaxException, IOException {
        String filename = "trebuchet.txt";
        String filenameSmall = "trebuchet-small.txt";
        String filenameWords = "trebuchet-with-words.txt";
        String filenameWordsSub = "trebuchet-subpart.txt";

        calibrationDocument = Files.readAllLines(Paths.get(getClass().getClassLoader().getResource(filename).toURI()));
        calibrationDocumentSmall = Files.readAllLines(Paths.get(getClass().getClassLoader().getResource(filenameSmall).toURI()));
        calibrationDocumentWords = Files.readAllLines(Paths.get(getClass().getClassLoader().getResource(filenameWords).toURI()));
        calibrationDocumentSub = Files.readAllLines(Paths.get(getClass().getClassLoader().getResource(filenameWordsSub).toURI()));
    ...
    void test() {
        ...
        assertEquals(55017, t.solve(calibrationDocument));
    }

    @Test
    void testSmall() {
        Trebuchet t = new Trebuchet();
        assertEquals(142, t.solve(calibrationDocumentSmall));
    }

    @Test
    void testWords() {
        Trebuchet t = new Trebuchet();
        assertEquals(281, t.solveWords(calibrationDocumentWords));
    }
    ...
    void testWordsLarge() {
        Trebuchet t = new Trebuchet();
        System.out.println();
        System.out.println("RESULT: " + t.solveWords(calibrationDocument));
        /*assertEquals(53551, t.solveWords(calibrationDocument));*/
    }

    @Test
    void testConvert() throws Exception {
        // Assuming calibrationDocumentWords is your input list
        Trebuchet t = new Trebuchet();
        List<String> result = t.convertLetterNumbers(calibrationDocumentSub);
        ...
        List<String> expectedResults = Files.readAllLines(
                Paths.get(getClass().getResource("/t-w-w-test.txt").toURI())
        );
    ...
    void testStringInput() {
        ...
        ArrayList<String> lines = new ArrayList<>(Arrays.asList(strings));
        Trebuchet t = new Trebuchet();
        //System.out.println("RESULT: " + t.solveWords(calibrationDocument));
        assertEquals(53551, t.solveWords(lines));
